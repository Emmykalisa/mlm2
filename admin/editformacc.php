...
if (count($_POST) > 0) {
    mysqli_query($con, "UPDATE accountant set Names='".$_POST['Names']."', NationalID='".$_POST['NationalID']."', mobile='".$_POST['mobile']."',`updated_at`=NOW() WHERE id='".$_GET['edit_id']."'"); ?>
<script>
...
<?php
    ...
    $result = mysqli_query($con, "SELECT * FROM accountant WHERE id='".$_GET['edit_id']."'");
